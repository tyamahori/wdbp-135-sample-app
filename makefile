...
COMPOSE_BASE_COMMAND := COMPOSE_PROJECT_NAME=$(PROJECT_NAME) USER_ID=$(USER_ID) \
 GROUP_ID=$(GROUP_ID) USER_NAME=$(USER_NAME) docker compose -f ./.docker/local/compose.yaml
